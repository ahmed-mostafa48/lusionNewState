  ...
  return (
    <Container>
        <div className='d-flex align-items-center justify-content-between mt-5 main ' >
          ...
          <Card inverse className='bg-light first'  style={{width:'65%' , height:'400px' ,backgroundColor:'palevioletred'}} > 
          ...
          <Card inverse className='bg-light second' style={{width:'25%' ,height:'400px',backgroundColor:'palevioletred'}}> 
