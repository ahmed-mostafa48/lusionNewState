      ...
      <Container className=' mt-5'>
        ...
        <div className='row d-flex align-items-center justify-content-center'  style={{gap: '70px'}}>
        {
          props.cartProducts.map((cartProduct)=>(
            cartProduct.count > 0 && 
            <CartProduct  key={cartProduct.id+'cart'} cartProduct={cartProduct}  incrementProduct={props.incrementProduct} decrementProduct={props.decrementProduct} removeProduct={props.removeProduct} />
